            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        -->                         
                        <li><a href="" data-toggle="modal" data-target="#elegantModalForm">Registrese</a></li>                    
                    </ul>
                </div>
                <div class="search">
                    <form role="form">
            ...
            <div class="row">
                <div class="main-slider">
                    <div class="slide-text">
                        ...
                        <a href="" class="btn btn-common" data-toggle="modal" data-target="#elegantModalForm">Ingresar</a>
                    </div>
            ...
            <div class="row">
                <div class="col-sm-4 text-center padding wow fadeIn" data-wow-duration="1000ms" data-wow-delay="300ms">
                    <div class="single-service">
                        ...
                        <p>Forme parte de nuestra comunidad. Realizar una cuenta es relativamente sencillo  a tan solo unos clicks</p>
                    </div>
                </div>
                ...
                <div class="col-sm-4 text-center padding wow fadeIn" data-wow-duration="1000ms" data-wow-delay="900ms">
                    <div class="single-service">
                        <div class="wow scaleIn" data-wow-duration="500ms" data-wow-delay="900ms">
                            <img src="images/home/icons3.png" alt="">
                        </div>
  ...
  <div class="modal-dialog" role="document">
    ...
    <div class="modal-content form-elegant">
      ...
      <div class="modal-header text-center">
        <h3 class="modal-title w-100 dark-grey-text font-weight-bold my-3" id="myModalLabel"><strong>Inicie Sesion</strong></h3>
      ...
      <div class="modal-body mx-4">
        ...
        <div class="md-form mb-5">
            <label data-error="wrong" data-success="right" for="Form-email1">Correo electronico</label>
        ...
        <p class="font-small dark-grey-text text-right d-flex justify-content-center mb-3 pt-2"> O ingrese con:</p>
        
        <div class="row my-3 d-flex text-right justify-content-center ">
          <button type="button" class="btn btn-white btn-rounded mr-md-3 z-depth-1a"><i class="fa fa-facebook text-center"></i></button>
          <button type="button" class="btn btn-white btn-rounded mr-md-3 z-depth-1a"><i class="fa fa-google-plus"></i></button>
...
<!--MODAL DE REGISTRO DE USUARIO-->
    <div class="modal fade" id="elegantModalFormRegister" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
  aria-hidden="true">
  <div class="modal-dialog" role="document">
    <!--Content-->
    <div class="modal-content form-elegant">
      <!--Header-->
      <div class="modal-header text-center">
        <h3 class="modal-title w-100 dark-grey-text font-weight-bold my-3" id="myModalLabel"><strong>Registro</strong></h3>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      ...
      <div class="modal-body mx-4">
        <!--Body-->
        <div class="md-form mb-5">
            <label data-error="wrong" data-success="right" for="Form-email1">Nombre</label>
            <input type="text" id="nombre-res" class="form-control validate">
        </div>
        <div class="md-form mb-5">
            <label data-error="wrong" data-success="right" for="Form-email1">Apellido Paterno</label>
            <input type="text" id="ap-res" class="form-control validate">
        </div>
        <div class="md-form mb-5">
            <label data-error="wrong" data-success="right" for="Form-email1">Apellido Materno</label>
            <input type="text" id="am-res" class="form-control validate">
        </div>
        <div class="md-form mb-5">
            <label data-error="wrong" data-success="right" for="Form-email1">Correo electronico</label>
            <input type="email" id="correo-res" class="form-control validate">
        </div>

        <div class="md-form pb-3">
            <label data-error="wrong" data-success="right" for="Form-pass1">Contraseña</label>
            <input type="password" id="pass-res" class="form-control validate">
            <!--<p class="font-small blue-text d-flex justify-content-end">¿No tiene cuenta?<a href="#" class="blue-text ml-1">
              Registrese aqui</a></p>-->
        </div>
        <div class="md-form mb-5">
            <label data-error="wrong" data-success="right" for="Form-email1">Direccion</label>
            <input type="text" id="direccion-res" class="form-control validate">
        </div>
        <p></p>
        <p></p>
        <div class="text-center mb-3">
          <button type="button" class="btn blue-gradient btn-block btn-rounded z-depth-1a">Registrarse</button>
        </div>
